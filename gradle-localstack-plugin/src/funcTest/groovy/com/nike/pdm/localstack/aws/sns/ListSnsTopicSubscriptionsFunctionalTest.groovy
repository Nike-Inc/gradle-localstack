...
class ListSnsTopicSubscriptionsFunctionalTest extends Specification {
    ...
    def "should list sns subscriptions"() {
        given:
        buildFile << """
        ...
        def result = GradleRunner.create()
                ...
                .withArguments('startLocalStack', 'listSnsTopicSubscriptions', '--topicName=catalog-product-drops')
                .withPluginClasspath()
                .build()

        then:
        result.task(":listSnsTopicSubscriptions").outcome == SUCCESS
    ...
    def "should return error for invalid topic"() {
        ...
        def result = GradleRunner.create()
                .withProjectDir(testProjectDir.root)
                .withArguments('startLocalStack', 'listSnsTopicSubscriptions', '--topicName=invalid-topic-name')
                .withPluginClasspath()
                .build()
